            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="p-8">
                    <PlaceholderPage
                        ...
                        description="Our terms of service outline the responsible use of AI intellectual companions and our commitment to providing a secure scholarly environment."
                    />
                </div>
            </div>
        </main>
